...
export default function SignInPage() {
  ...
  const { signInEmail, signInWithGoogle, signInWithGithub, signInAnonymous } = useAuth()
      ...
      >
        <Card className="bg-black/40 backdrop-blur-xl border-white/10 shadow-2xl">
          <CardHeader className="space-y-3 text-center">
            ...
            <CardDescription className="text-white/60">Sign in to access Campus World</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full h-12 text-white/70 hover:text-white hover:bg-white/5"
            >
              Continue as Guest
            </Button>
